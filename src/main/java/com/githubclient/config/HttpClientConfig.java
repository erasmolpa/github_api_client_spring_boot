 ...
 *
 * This Configuration is used by {@link RestApiConfig}
 */
@Configuration
@EnableScheduling
public class HttpClientConfig {
     ...
     *  This means that connections don’t have to be re-established every time, saving us a lot of overhead and time.
     * */
    ...
    /***
     *  Connection monitor that runs every 10 seconds and closes outdated connections as well as long waiting connections
     */
    @Bean
